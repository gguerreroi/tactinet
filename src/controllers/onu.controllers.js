...
export async function get_onu_administrative_status(req, res){
    const {id} = req.params;
...
export async function get_onu_catv_status(req, res){
    const {id} = req.params;
...
export async function get_onu_full_status_info(req, res){
    const {id} = req.params;
